...
export const getIssue = async (issueId: number, github: GitHub): Promise<Issue | null> => {
    ...
    return issue.repository.issue ? IssueSerializer.fromJSON(issue.repository.issue) : null;
};